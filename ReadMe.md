...
Allows you to create paths within React to "load" a new page, but since React is a SPA it isn't really loading a new page, its just mounting new components to show new content
